        ...
        await collection.updateOne(
            ...
            { 
                $set: {
                    ...
                    "state.round" : new_room.state?.round,
                    "state.stage" : new_room.state?.stage,
                    "state.judge_index" : new_room.state?.judge_index,
                    "state.judge_data" : new_room.state?.judge_data,
                    "state.respondent_data" : new_room.state?.respondent_data
                },
                $push: {
                    "state.jokers": new_room.state?.jokers
                }
            }
