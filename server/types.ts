...
export const Jokers: Record<string, string> = {
	...
	Mirror:
		"Makes the other player have to comply with the sentence as well. Only once; +4 doesn't affect Mirror",
...
export type JokerList = (keyof typeof Jokers)[];
...
export type RoomType = {
	...
	state: GameState; // Game state is created once both players join, if null game hasn't started, meaning both players are in waiting room
...
export type GameState = {
	round: number;
	stage: 1 | 2 | 3;
	jokers: Record<number, JokerList>; // {Memmber index: [joker1, joker2, joker3]}.
